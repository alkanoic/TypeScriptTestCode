...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // typescript/superlit/superlit.ts
  var SuperElement = class extends s4 {
    render() {
      return y` <div>Content</div> `;
    }
  };
  SuperElement.styles = i`
    div {
      border: 1px solid gray;
      padding: 8px;
    }
  `;
  SuperElement = __decorateClass([
    e4("super-element")
  ], SuperElement);

  // typescript/littest.ts
  ...
  var MyPage = class extends s4 {
    ...
    headerTemplate() {
      return y`<header>${this.article.title}</header>`;
    }
    articleTemplate() {
      return y`<article>${this.article.text}</article>`;
    }
    footerTemplate() {
      return y`<footer>Your footer here.</footer>`;
    }
    render() {
      return y` ${this.headerTemplate()} ${this.articleTemplate()} ${this.footerTemplate()} `;
    }
  };
  __decorateClass([
    e5({ attribute: false })
  ], MyPage.prototype, "article", 2);
  ...
  ], MyElement.prototype, "active", 2);
  MyElement = __decorateClass([
    e4("my-element")
  ], MyElement);
  var MySuperElement = class extends SuperElement {
  };
  MySuperElement.styles = [
    SuperElement.styles,
    i`
      div {
        color: red;
  ...
  MySuperElement = __decorateClass([
    e4("my-super-element")
  ], MySuperElement);
  var MySlotElement = class extends s4 {
    render() {
      return y`
      <p>
        <slot name="one"></slot>
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
//# sourceMappingURL=littest.js.map
